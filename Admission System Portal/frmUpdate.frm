...
Begin VB.Form frmUpdate 
   ...
   Begin MSAdodcLib.Adodc Adodc1 
      ...
      _Version        =   393216
   End
   Begin VB.CommandButton cmdmodifyP 
      ...
      Width           =   4095
   End
   Begin VB.CommandButton cmdupdate_Q 
...
Private Sub cmdmodifyP_Click()
 frmUpdateP.Show
 Me.Hide
 
End Sub

Private Sub cmdupdate_Q_Click()
 frmUpdateQ.Show
 Me.Hide
...
Private Sub Form_Load()
 j = Val(InputBox("Enter id ", " ", " ", 200, 200))
End Sub
